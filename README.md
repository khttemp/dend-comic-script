...
dend-comic-script は、電車でD ShiningStage のコミックスクリプトをダンプするソフトウェアである。

## 動作環境

* 電車でD ShiningStage が動くコンピュータであること
...
安全を担保したうえで実行すること。
このプログラムについて、電車でD ShiningStage 作者である、地主一派へ問い合わせてはいけない。
...
電車でD ShiningStage の正式なライセンスを持っていること。
